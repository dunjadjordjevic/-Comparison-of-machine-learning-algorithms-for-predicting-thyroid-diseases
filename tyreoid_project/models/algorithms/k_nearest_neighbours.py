...
def get_neighbours(train_set, test_entry, number_of_neighbors):
    ...
    for train_entry in train_set:
        distance_from_neighbour = euclidean_distance(train_entry, test_entry)
...
def predict_classification(train_set, test_row, number_of_neighbors):

    list_of_neighbours = get_neighbours(train_set, test_row, number_of_neighbors)
...
def k_nearest_neighbors(train_set, test_set, columns, number_of_neighbors):

    prediction_values = list()
    for entry in test_set:
        prediction_value = predict_classification(train_set, entry, number_of_neighbors)
